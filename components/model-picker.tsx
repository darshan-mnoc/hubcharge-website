    ...
    <div>
      ...
      <div className="relative">
        <select
          ...
          className={`w-full appearance-none rounded-lg border pl-3 pr-9 py-2.5 text-body-sm focus:outline-none focus:border-brand focus:ring-2 focus:ring-brand/25 ${
            dark
              ? "border-white/20 bg-ink-800 text-white"
              : "border-paper-300 bg-paper text-ink-900"
          }`}
        >
